  ...
  return (
    <>
      ...
      <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-scroll scrollbar-hidden bg-gray-50">
          <NavLink to="#" className='flex items-center ps-2.5 mb-5 bg-gray-50'>
            <img src={logo} className="h-6 me-3 sm:h-7" alt="Fun&Funding Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap">Fun&Funding</span>
          </NavLink>
          ...
          <ul className="space-y-2 font-medium list-none">
            <li>
              <NavLink to="/admin-dashboard/dashboard" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
            ...
            <li>
              ...
              {isOpenManagement && (
                <ul id="dropdown-example" className="py-2 space-y-2 list-none text-sm">
                  <li>
                    <NavLink to="/admin-dashboard/users" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      <svg className="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                  ...
                  <li>
                    <NavLink to="" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Funding categories</span>
                    </NavLink>
                  </li>
                </ul>
              )}
                ...
                <ul id="dropdown-example" className="py-1 space-y-2 list-none text-sm">
                  <li>
                    <NavLink to="" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Funding Projects</span>
                      <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-dark-green bg-primary-green/20 rounded-full">3</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin-dashboard/milestone-request" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      <svg className="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        <path d="M18 0H6a2 2 0 0 0-2 2h14v12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Z" />
                        <path d="M14 4H2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM2 16v-6h12v6H2Z" />
                      </svg>
                  ...
                  <li>
                    <NavLink to="" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      <svg
                        className="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 group-hover:text-gray-900"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 18 21"
                  ...
                  <li>
                    <NavLink to="" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      <svg className="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.96 2.96 0 0 0 .13 5H5Z" />
                        <path d="M6.737 11.061a2.961 2.961 0 0 1 .81-1.515l6.117-6.116A4.839 4.839 0 0 1 16 2.141V2a1.97 1.97 0 0 0-1.933-2H7v5a2 2 0 0 1-2 2H0v11a1.969 1.969 0 0 0 1.933 2h12.134A1.97 1.97 0 0 0 16 18v-3.093l-1.546 1.546c-.413.413-.94.695-1.513.81l-3.4.679a2.947 2.947 0 0 1-1.85-.227 2.96 2.96 0 0 1-1.635-3.257l.681-3.397Z" />
                        <path d="M8.961 16a.93.93 0 0 0 .189-.019l3.4-.679a.961.961 0 0 0 .49-.263l6.118-6.117a2.884 2.884 0 0 0-4.079-4.078l-6.117 6.117a.96.96 0 0 0-.263.491l-.679 3.4A.961.961 0 0 0 8.961 16Zm7.477-9.8a.958.958 0 0 1 .68-.281.961.961 0 0 1 .682 1.644l-.315.315-1.36-1.36.313-.318Zm-5.911 5.911 4.236-4.236 1.359 1.359-4.236 4.237-1.7.339.341-1.699Z" />
                      </svg>
                      <span className="flex-1 ms-3 whitespace-nowrap">Wallet Withdrawal</span>
                      <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-dark-green bg-primary-green/20 rounded-full">3</span>
                    </NavLink>
                  </li>
                  <li>
          ...
          <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 list-none text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Configuration</span>
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <ul id="dropdown-example" className="py-1 space-y-2 list-none ">
                  <li>
                    <NavLink to="/admin-dashboard/commission" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Commission</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin-dashboard/milestones" className={({ isActive }) => `${isActive ? activeBg : ''} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">Disbursement milestones</span>
                    </NavLink>
                  </li>
                </ul>
              )}
