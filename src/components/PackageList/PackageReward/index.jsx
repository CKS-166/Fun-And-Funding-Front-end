            ...
            >
                ...
                {sortedPackageList.map((item, index) => (
                    <>
                            ...
                            <Box className="package-reward" sx={{ height: '407px', overflowY: 'auto' }}>
                                <Box sx={{ display: 'flex', padding: '34px' }} >
                                    ...
                                    <Box sx={{ width: '50%' }}>
                                        ...
                                        <Typography sx={{ fontSize: '16px', fontWeight: '700', marginTop: '10px', border: '1px solid #1BAA64' }}>
                                            <Box sx={{ width: 500, maxWidth: '100%' }}>
                                                <TextField fullWidth id="input-with-icon-adornment"
                                                    value={donatedMoney}
                        ...
                        </Grid> : <Grid key={index} size={6} sx={{ overflowY: 'auto' }}>
                            <Box className="package-reward" sx={{ height: '407px', overflowY: 'auto' }}>
                                <Box sx={{ display: 'flex', padding: '34px' }} >
                                    <Box className='package-image' sx={{ width: '50%' }}>
                                        <img src={kuru} />
