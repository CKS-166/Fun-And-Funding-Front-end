...
const UpdatesSection = () => {
  return (
    <>
        <Box sx={{width : '800px', border : '1px solid rgba(0, 0, 0, 0.3)'
            ...
            <Typography sx={{background : 'rgba(0, 0, 0, 0.3)', width: '700px', height : '1px',
                marginTop : '8px'
            }}></Typography>
            <Box>
                <img src={kuru} style={{width : '700px', height : '185px', objectFit : 'cover' , 
