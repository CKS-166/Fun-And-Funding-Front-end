            ...
            {role == "GameOwner" ? <>
                <div className='w-[100%] mb-[4rem]'>
                    <div className="flex justify-start gap-[1rem] items-start flex-col mb-[4rem]">
                        ...
                        >
                            Track and manage your crowdfunding projects, monitor progress, and engage with supporters to bring your ideas to life.
                        </Typography>
                    </div>
                ...
                <div className='w-[100%]'>
                    <div className="flex justify-start gap-[1rem] items-start flex-col mb-[4rem]">
                        ...
                        >
                            Manage the details, content, and updates for your marketplace projects, ensuring they are ready for the audience.
                        </Typography>
                    </div>
                    <div className='flex flex-row justify-between gap-[1rem] mb-[2rem]'>
                        <SearchBar onSearchChange={handleOwnerProjectSearchChange} />
                ...
                <div className='w-[100%]'>
                    <div className="flex justify-start gap-[1rem] items-start flex-col mb-[4rem]">
                        ...
                        >
                            View and track all the funding projects you’ve supported, including their updates and achievements.
                        </Typography>
                    </div>
                    <div className='flex flex-row justify-between gap-[1rem] mb-[2rem]'>
