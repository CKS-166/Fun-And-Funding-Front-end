  ...
  const handleImageChange = (e, index, isEditing = false) => {
    ...
    if (file) {
      ...
      if (isEditing) {
        ...
        setEditRewardItem((prev) => ({
          ...prev,
          imageFile: imageUrl, // Temporary URL
        }));
      } else {
        // Update the reward item being added
        const updatedRewardItems = [...packageData.rewardItems];
        updatedRewardItems[index] = {
          ...updatedRewardItems[index],
          imageFile: imageUrl, // Temporary URL
        };
        setPackageData((prev) => ({
                ...
                <tr key={index} className="bg-white border-b hover:bg-gray-50 ">
                  <td className="px-2 py-4 flex justify-center">
                    <label className="flex items-center justify-center w-[3rem] h-[3rem] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ">
                      ...
                      {editRewardItem.imageFile ? (
                        <img
                          src={editRewardItem.imageFile}
                          alt="Reward Preview"
              ...
              <tr className="bg-white border-b hover:bg-gray-50 ">
                <td className="px-2 py-4 flex justify-center">
                  <label className="flex items-center justify-center w-[3rem] h-[3rem] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ">
                    ...
                    {newRewardItem.imageFile ? (
                      <img
                        src={newRewardItem.imageFile}
                        alt="Reward Preview"
                        className="w-[3rem] h-[3rem] object-cover rounded-lg"
                      />
                    ) : (
