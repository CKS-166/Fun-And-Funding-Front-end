...
function LoginForm({ onClose, onOpenRoleSelection }) {
  ...
  const handleSignUpClick = () => {
    ...
    onOpenRoleSelection(); // Open the role selection popup
  };
    ...
    <div className="fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-75 z-50">
      ...
      >
        ...
        <div className="flex justify-between gap-4 mb-6">
          <button className="flex items-center justify-center gap-2 w-full py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-600 hover:bg-gray-50 transition-all duration-200">
