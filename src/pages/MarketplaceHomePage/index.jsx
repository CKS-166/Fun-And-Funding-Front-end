        ...
        <div>
            ...
            <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
                <div class="mx-auto w-[90vw] px-4 2xl:px-0">
                    ...
                    <Grid2 container>
                        <Grid2 size={3}>
                            <div id="dropdown" class="z-10 w-[90%] p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                                <h6 class="mb-3 text-xl font-medium text-gray-900 dark:text-white">
                                    Category (hardcode)
                                </h6>
                                <ul class="space-y-2 text-md" aria-labelledby="dropdownDefault">
                                    <li class="flex items-center">
                                        ...
                                        <label for="apple" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            Apple (56)
                                        </label>
                                    </li>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <label for="fitbit" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            Fitbit (56)
                                        </label>
                                    </li>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <label for="dell" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            Dell (56)
                                        </label>
                                    </li>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <label for="asus" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            Asus (97)
                                        </label>
                                    </li>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <label for="logitech" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            Logitech (97)
                                        </label>
                                    </li>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <label for="msi" class="ml-2 text-md font-medium text-gray-900 dark:text-gray-100">
                                            MSI (97)
                                        </label>
                                    </li>
                                    ...
                                    return (
                                        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                            <div class="h-56 w-full">
                                                ...
                                                >
                                                    <img class="mx-auto h-full dark:hidden object-contain" src={fileWithType2?.url || "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/800px-Image_not_available.png"} alt="Game product image" />
                                                </a>
                                            </div>
                                            <div class="pt-6">
                                                <div class="mb-4 flex items-center justify-between gap-4">
                                                    <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300 bg-primary-green/30"> Up to 35% off (hardcode)</span>
                                                </div>

                                                <a
                                                    onClick={() => navigate(`/marketplace-detail/${item.id}`)}
                                                    class="text-lg font-semibold leading-tight hover:cursor-pointer text-gray-900 hover:underline dark:text-white">{item.name}</a>
                                                ...
                                                <div class="mt-2 flex items-center gap-2">
                                                    ...
                                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">(455) (hardcode)</p>
                                                </div>

                                                <ul class="mt-2 flex items-center gap-4 ml-0">
                                                    <li class="flex items-center gap-2">
                                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Category 1</p>
                                                    </li>

                                                    <li class="flex items-center gap-2">
                                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Category 2 (hardcode)</p>
                                                    </li>
                                                </ul>

                                                <div class="mt-4 flex items-center justify-between gap-4">
                                                    <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">{item.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")} VND</p>

                                                    <button
                                                        onClick={() => navigate(`/marketplace-detail/${item.id}`)}
                                                        type="button" class="inline-flex items-center rounded-lg bg-primary-green px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
